...
import 'dart:ui';
import 'package:mygame/home_page.dart';
...
class _SignInPageState extends State<SignInPage> {
  ...
  void _startLoginFlow() async {
    ...
    Navigator.of(context).push(
      PageRouteBuilder(
        ...
        pageBuilder: (_, __, ___) => const LoadingFullScreen(),
      ),
    );
                      ...
                      child: Container(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              // Title
                              _glowText("Welcome Back!", size.width * 0.1),
  ...
  // Floating Label Input — Same as Sign Up (perfect consistency)
